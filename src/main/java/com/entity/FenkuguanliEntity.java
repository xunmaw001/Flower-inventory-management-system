...
public class FenkuguanliEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public FenkuguanliEntity() {

	}

	public FenkuguanliEntity(T t) {
		try {
    ...
    public String toString() {
        return "Fenkuguanli{" +
            ...
            ", username=" + username +
            ", password=" + password +
            ", fenkuguanliName=" + fenkuguanliName +
            ", fenkuguanliPhoto=" + fenkuguanliPhoto +
            ", fenkuguanliPhone=" + fenkuguanliPhone +
            ", fenkuguanliEmail=" + fenkuguanliEmail +
            ", sexTypes=" + sexTypes +
