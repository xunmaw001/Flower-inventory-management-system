<template>
    <div style="backgroundImage: url('/huahuikucuenguanli/img/back-img-bg.jpg');background-size:cover;">
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">花卉库存管理系统注册</h1>
                <el-form class="rgs-form" label-width="120px">
                        ...
                        <el-form-item label="员工姓名" class="input" v-if="tableName=='fenkuguanli'">
                            <el-input v-model="ruleForm.fenkuguanliName" autocomplete="off" placeholder="员工姓名"  />
                        </el-form-item>
                        <el-form-item label="手机号" class="input" v-if="tableName=='fenkuguanli'">
                            <el-input v-model="ruleForm.fenkuguanliPhone" autocomplete="off" placeholder="手机号"  />
                        </el-form-item>
                        <el-form-item label="电子邮箱" class="input" v-if="tableName=='fenkuguanli'">
                            <el-input v-model="ruleForm.fenkuguanliEmail" autocomplete="off" placeholder="电子邮箱"  />
                        </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            if((!this.ruleForm.fenkuguanliName)&& 'fenkuguanli'==this.tableName){
                                this.$message.error('员工姓名不能为空');
                                return
                            }
                             if('fenkuguanli' == this.tableName && this.ruleForm.fenkuguanliPhone&&(!this.$validate.isMobile(this.ruleForm.fenkuguanliPhone))){
                                 this.$message.error('手机应输入手机格式');
                                 return
                             }
                            if('fenkuguanli' == this.tableName && this.ruleForm.fenkuguanliEmail&&(!this.$validate.isEmail(this.ruleForm.fenkuguanliEmail))){
